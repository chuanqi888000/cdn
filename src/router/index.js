...
const projectManagement = () => import("@/views/projectManagement/view")
const deploymentStatistical = () => import("@/views/deploymentStatistical/view")
const DeploymentManagement = () => import("@/views/deploymentManagement/view")
const homeworkDeployment = () => import("@/views/homeworkDeployment/view")
// projectManagement: "项目管理",
//         deploymentStatistical: "部署统计",
//         homeworkDeployment: "作业部署"
/**
 * 重写路由的push方法
 */
...
let addRouter = [
    {
        ...
        children: [
            ...
            },
            {
                ...
                iconCls: "el-icon-edit-outline", // 图标样式class
                name: routeName.homeworkDeployment,
                component: homeworkDeployment,
                children: []
            }
        ]
    },
    ...
    {
        path: "/deploymentStatistical",
        iconCls: "fa fa-dashboard", // 图标样式class
        name: routeName.deploymentStatistical,
        component: Layout,
        alone: true,
        children: [
            {
                ...
                iconCls: "fa fa-dashboard", // 图标样式class
                name: routeName.deploymentStatistical,
                component: deploymentStatistical,
                children: []
            }
        ]
    },
